...
option(MSVC_MULTIPROCESSOR_COMPILE "Enable multiprocessor comilation everywhere (disables minimal rebuild in debug mode)" ON)
...
# Release
set(CMAKE_C_FLAGS_RELEASE "/MP /GS- /GL /W2 /Gy- /Zi /O2 /Ob2 /fp:fast /GF /Oy /Oi")
set(CMAKE_CXX_FLAGS_RELEASE "/MP /GS- /GL /W2 /Gy- /Zi /O2 /Ob2 /fp:fast /GF /Oy /Oi")
...
# Debug
set(CMAKE_C_FLAGS_DEBUG "/GS /W4 /Gy /ZI /Od /RTC1 /Gd /Oy-")
set(CMAKE_CXX_FLAGS_DEBUG "/Gm /GS /W4 /Gy /ZI /Od /RTC1 /Gd /Oy-")
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "/MAP /DEBUG /INCREMENTAL /NODEFAULTLIB:libc.lib /NODEFAULTLIB:libcd.lib /NODEFAULTLIB:libcmt.lib /NODEFAULTLIB:libci.lib")

IF(NOT MSVC_MULTIPROCESSOR_COMPILE)
	set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} /Gm")
	set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /Gm")
ENDIF(NOT MSVC_MULTIPROCESSOR_COMPILE)
...
IF(MSVC_MULTIPROCESSOR_COMPILE)
	INCLUDE(MSVCMultipleProcessCompile)
ENDIF(MSVC_MULTIPROCESSOR_COMPILE)
