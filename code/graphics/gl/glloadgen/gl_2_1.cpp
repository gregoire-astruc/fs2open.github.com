...
namespace gl2
{
	namespace gl
	{
		namespace exts
		{
			LoadTest var_EXT_fog_coord;
			LoadTest var_ARB_multitexture;
			LoadTest var_ARB_texture_env_add;
			LoadTest var_EXT_texture_env_add;
			LoadTest var_ARB_texture_compression;
			LoadTest var_EXT_texture_compression_s3tc;
			LoadTest var_EXT_texture_filter_anisotropic;
			LoadTest var_ARB_texture_env_combine;
			LoadTest var_EXT_texture_env_combine;
			LoadTest var_EXT_compiled_vertex_array;
			LoadTest var_EXT_draw_range_elements;
			LoadTest var_ARB_texture_mirrored_repeat;
			LoadTest var_ARB_texture_non_power_of_two;
			LoadTest var_ARB_vertex_buffer_object;
			LoadTest var_ARB_pixel_buffer_object;
			LoadTest var_EXT_pixel_buffer_object;
			LoadTest var_SGIS_generate_mipmap;
			LoadTest var_EXT_framebuffer_object;
			LoadTest var_ARB_texture_rectangle;
			LoadTest var_NV_texture_rectangle;
			LoadTest var_EXT_bgra;
			LoadTest var_ARB_texture_cube_map;
			LoadTest var_EXT_texture_cube_map;
			LoadTest var_EXT_texture_lod_bias;
			LoadTest var_ARB_point_sprite;
			LoadTest var_NV_point_sprite;
			LoadTest var_ARB_shading_language_100;
			LoadTest var_ARB_shader_objects;
			LoadTest var_ARB_vertex_shader;
			LoadTest var_ARB_fragment_shader;
			LoadTest var_ARB_shader_texture_lod;
			LoadTest var_NV_vertex_program3;
			LoadTest var_ARB_texture_float;
			LoadTest var_ARB_draw_elements_base_vertex;
			
		} //namespace exts
		
		namespace _detail
		{
			typedef void (CODEGEN_FUNCPTR *PFNFOGCOORDPOINTEREXT)(GLenum, GLsizei, const GLvoid *);
			PFNFOGCOORDPOINTEREXT FogCoordPointerEXT = 0;
			typedef void (CODEGEN_FUNCPTR *PFNFOGCOORDDEXT)(GLdouble);
			PFNFOGCOORDDEXT FogCoorddEXT = 0;
			typedef void (CODEGEN_FUNCPTR *PFNFOGCOORDDVEXT)(const GLdouble *);
			PFNFOGCOORDDVEXT FogCoorddvEXT = 0;
			typedef void (CODEGEN_FUNCPTR *PFNFOGCOORDFEXT)(GLfloat);
			PFNFOGCOORDFEXT FogCoordfEXT = 0;
			typedef void (CODEGEN_FUNCPTR *PFNFOGCOORDFVEXT)(const GLfloat *);
			PFNFOGCOORDFVEXT FogCoordfvEXT = 0;
			
			static int Load_EXT_fog_coord()
			{
				int numFailed = 0;
				FogCoordPointerEXT = reinterpret_cast<PFNFOGCOORDPOINTEREXT>(IntGetProcAddress("glFogCoordPointerEXT"));
				if(!FogCoordPointerEXT) ++numFailed;
				FogCoorddEXT = reinterpret_cast<PFNFOGCOORDDEXT>(IntGetProcAddress("glFogCoorddEXT"));
				if(!FogCoorddEXT) ++numFailed;
				FogCoorddvEXT = reinterpret_cast<PFNFOGCOORDDVEXT>(IntGetProcAddress("glFogCoorddvEXT"));
				if(!FogCoorddvEXT) ++numFailed;
				FogCoordfEXT = reinterpret_cast<PFNFOGCOORDFEXT>(IntGetProcAddress("glFogCoordfEXT"));
				if(!FogCoordfEXT) ++numFailed;
				FogCoordfvEXT = reinterpret_cast<PFNFOGCOORDFVEXT>(IntGetProcAddress("glFogCoordfvEXT"));
				if(!FogCoordfvEXT) ++numFailed;
				return numFailed;
			}
			
			typedef void (CODEGEN_FUNCPTR *PFNACTIVETEXTUREARB)(GLenum);
			PFNACTIVETEXTUREARB ActiveTextureARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNCLIENTACTIVETEXTUREARB)(GLenum);
			PFNCLIENTACTIVETEXTUREARB ClientActiveTextureARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1DARB)(GLenum, GLdouble);
			PFNMULTITEXCOORD1DARB MultiTexCoord1dARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1DVARB)(GLenum, const GLdouble *);
			PFNMULTITEXCOORD1DVARB MultiTexCoord1dvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1FARB)(GLenum, GLfloat);
			PFNMULTITEXCOORD1FARB MultiTexCoord1fARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1FVARB)(GLenum, const GLfloat *);
			PFNMULTITEXCOORD1FVARB MultiTexCoord1fvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1IARB)(GLenum, GLint);
			PFNMULTITEXCOORD1IARB MultiTexCoord1iARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1IVARB)(GLenum, const GLint *);
			PFNMULTITEXCOORD1IVARB MultiTexCoord1ivARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1SARB)(GLenum, GLshort);
			PFNMULTITEXCOORD1SARB MultiTexCoord1sARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD1SVARB)(GLenum, const GLshort *);
			PFNMULTITEXCOORD1SVARB MultiTexCoord1svARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2DARB)(GLenum, GLdouble, GLdouble);
			PFNMULTITEXCOORD2DARB MultiTexCoord2dARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2DVARB)(GLenum, const GLdouble *);
			PFNMULTITEXCOORD2DVARB MultiTexCoord2dvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2FARB)(GLenum, GLfloat, GLfloat);
			PFNMULTITEXCOORD2FARB MultiTexCoord2fARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2FVARB)(GLenum, const GLfloat *);
			PFNMULTITEXCOORD2FVARB MultiTexCoord2fvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2IARB)(GLenum, GLint, GLint);
			PFNMULTITEXCOORD2IARB MultiTexCoord2iARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2IVARB)(GLenum, const GLint *);
			PFNMULTITEXCOORD2IVARB MultiTexCoord2ivARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2SARB)(GLenum, GLshort, GLshort);
			PFNMULTITEXCOORD2SARB MultiTexCoord2sARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD2SVARB)(GLenum, const GLshort *);
			PFNMULTITEXCOORD2SVARB MultiTexCoord2svARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3DARB)(GLenum, GLdouble, GLdouble, GLdouble);
			PFNMULTITEXCOORD3DARB MultiTexCoord3dARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3DVARB)(GLenum, const GLdouble *);
			PFNMULTITEXCOORD3DVARB MultiTexCoord3dvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3FARB)(GLenum, GLfloat, GLfloat, GLfloat);
			PFNMULTITEXCOORD3FARB MultiTexCoord3fARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3FVARB)(GLenum, const GLfloat *);
			PFNMULTITEXCOORD3FVARB MultiTexCoord3fvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3IARB)(GLenum, GLint, GLint, GLint);
			PFNMULTITEXCOORD3IARB MultiTexCoord3iARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3IVARB)(GLenum, const GLint *);
			PFNMULTITEXCOORD3IVARB MultiTexCoord3ivARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3SARB)(GLenum, GLshort, GLshort, GLshort);
			PFNMULTITEXCOORD3SARB MultiTexCoord3sARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD3SVARB)(GLenum, const GLshort *);
			PFNMULTITEXCOORD3SVARB MultiTexCoord3svARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4DARB)(GLenum, GLdouble, GLdouble, GLdouble, GLdouble);
			PFNMULTITEXCOORD4DARB MultiTexCoord4dARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4DVARB)(GLenum, const GLdouble *);
			PFNMULTITEXCOORD4DVARB MultiTexCoord4dvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4FARB)(GLenum, GLfloat, GLfloat, GLfloat, GLfloat);
			PFNMULTITEXCOORD4FARB MultiTexCoord4fARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4FVARB)(GLenum, const GLfloat *);
			PFNMULTITEXCOORD4FVARB MultiTexCoord4fvARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4IARB)(GLenum, GLint, GLint, GLint, GLint);
			PFNMULTITEXCOORD4IARB MultiTexCoord4iARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4IVARB)(GLenum, const GLint *);
			PFNMULTITEXCOORD4IVARB MultiTexCoord4ivARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4SARB)(GLenum, GLshort, GLshort, GLshort, GLshort);
			PFNMULTITEXCOORD4SARB MultiTexCoord4sARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNMULTITEXCOORD4SVARB)(GLenum, const GLshort *);
			PFNMULTITEXCOORD4SVARB MultiTexCoord4svARB = 0;
			
			static int Load_ARB_multitexture()
			{
				int numFailed = 0;
				ActiveTextureARB = reinterpret_cast<PFNACTIVETEXTUREARB>(IntGetProcAddress("glActiveTextureARB"));
				if(!ActiveTextureARB) ++numFailed;
				ClientActiveTextureARB = reinterpret_cast<PFNCLIENTACTIVETEXTUREARB>(IntGetProcAddress("glClientActiveTextureARB"));
				if(!ClientActiveTextureARB) ++numFailed;
				MultiTexCoord1dARB = reinterpret_cast<PFNMULTITEXCOORD1DARB>(IntGetProcAddress("glMultiTexCoord1dARB"));
				if(!MultiTexCoord1dARB) ++numFailed;
				MultiTexCoord1dvARB = reinterpret_cast<PFNMULTITEXCOORD1DVARB>(IntGetProcAddress("glMultiTexCoord1dvARB"));
				if(!MultiTexCoord1dvARB) ++numFailed;
				MultiTexCoord1fARB = reinterpret_cast<PFNMULTITEXCOORD1FARB>(IntGetProcAddress("glMultiTexCoord1fARB"));
				if(!MultiTexCoord1fARB) ++numFailed;
				MultiTexCoord1fvARB = reinterpret_cast<PFNMULTITEXCOORD1FVARB>(IntGetProcAddress("glMultiTexCoord1fvARB"));
				if(!MultiTexCoord1fvARB) ++numFailed;
				MultiTexCoord1iARB = reinterpret_cast<PFNMULTITEXCOORD1IARB>(IntGetProcAddress("glMultiTexCoord1iARB"));
				if(!MultiTexCoord1iARB) ++numFailed;
				MultiTexCoord1ivARB = reinterpret_cast<PFNMULTITEXCOORD1IVARB>(IntGetProcAddress("glMultiTexCoord1ivARB"));
				if(!MultiTexCoord1ivARB) ++numFailed;
				MultiTexCoord1sARB = reinterpret_cast<PFNMULTITEXCOORD1SARB>(IntGetProcAddress("glMultiTexCoord1sARB"));
				if(!MultiTexCoord1sARB) ++numFailed;
				MultiTexCoord1svARB = reinterpret_cast<PFNMULTITEXCOORD1SVARB>(IntGetProcAddress("glMultiTexCoord1svARB"));
				if(!MultiTexCoord1svARB) ++numFailed;
				MultiTexCoord2dARB = reinterpret_cast<PFNMULTITEXCOORD2DARB>(IntGetProcAddress("glMultiTexCoord2dARB"));
				if(!MultiTexCoord2dARB) ++numFailed;
				MultiTexCoord2dvARB = reinterpret_cast<PFNMULTITEXCOORD2DVARB>(IntGetProcAddress("glMultiTexCoord2dvARB"));
				if(!MultiTexCoord2dvARB) ++numFailed;
				MultiTexCoord2fARB = reinterpret_cast<PFNMULTITEXCOORD2FARB>(IntGetProcAddress("glMultiTexCoord2fARB"));
				if(!MultiTexCoord2fARB) ++numFailed;
				MultiTexCoord2fvARB = reinterpret_cast<PFNMULTITEXCOORD2FVARB>(IntGetProcAddress("glMultiTexCoord2fvARB"));
				if(!MultiTexCoord2fvARB) ++numFailed;
				MultiTexCoord2iARB = reinterpret_cast<PFNMULTITEXCOORD2IARB>(IntGetProcAddress("glMultiTexCoord2iARB"));
				if(!MultiTexCoord2iARB) ++numFailed;
				MultiTexCoord2ivARB = reinterpret_cast<PFNMULTITEXCOORD2IVARB>(IntGetProcAddress("glMultiTexCoord2ivARB"));
				if(!MultiTexCoord2ivARB) ++numFailed;
				MultiTexCoord2sARB = reinterpret_cast<PFNMULTITEXCOORD2SARB>(IntGetProcAddress("glMultiTexCoord2sARB"));
				if(!MultiTexCoord2sARB) ++numFailed;
				MultiTexCoord2svARB = reinterpret_cast<PFNMULTITEXCOORD2SVARB>(IntGetProcAddress("glMultiTexCoord2svARB"));
				if(!MultiTexCoord2svARB) ++numFailed;
				MultiTexCoord3dARB = reinterpret_cast<PFNMULTITEXCOORD3DARB>(IntGetProcAddress("glMultiTexCoord3dARB"));
				if(!MultiTexCoord3dARB) ++numFailed;
				MultiTexCoord3dvARB = reinterpret_cast<PFNMULTITEXCOORD3DVARB>(IntGetProcAddress("glMultiTexCoord3dvARB"));
				if(!MultiTexCoord3dvARB) ++numFailed;
				MultiTexCoord3fARB = reinterpret_cast<PFNMULTITEXCOORD3FARB>(IntGetProcAddress("glMultiTexCoord3fARB"));
				if(!MultiTexCoord3fARB) ++numFailed;
				MultiTexCoord3fvARB = reinterpret_cast<PFNMULTITEXCOORD3FVARB>(IntGetProcAddress("glMultiTexCoord3fvARB"));
				if(!MultiTexCoord3fvARB) ++numFailed;
				MultiTexCoord3iARB = reinterpret_cast<PFNMULTITEXCOORD3IARB>(IntGetProcAddress("glMultiTexCoord3iARB"));
				if(!MultiTexCoord3iARB) ++numFailed;
				MultiTexCoord3ivARB = reinterpret_cast<PFNMULTITEXCOORD3IVARB>(IntGetProcAddress("glMultiTexCoord3ivARB"));
				if(!MultiTexCoord3ivARB) ++numFailed;
				MultiTexCoord3sARB = reinterpret_cast<PFNMULTITEXCOORD3SARB>(IntGetProcAddress("glMultiTexCoord3sARB"));
				if(!MultiTexCoord3sARB) ++numFailed;
				MultiTexCoord3svARB = reinterpret_cast<PFNMULTITEXCOORD3SVARB>(IntGetProcAddress("glMultiTexCoord3svARB"));
				if(!MultiTexCoord3svARB) ++numFailed;
				MultiTexCoord4dARB = reinterpret_cast<PFNMULTITEXCOORD4DARB>(IntGetProcAddress("glMultiTexCoord4dARB"));
				if(!MultiTexCoord4dARB) ++numFailed;
				MultiTexCoord4dvARB = reinterpret_cast<PFNMULTITEXCOORD4DVARB>(IntGetProcAddress("glMultiTexCoord4dvARB"));
				if(!MultiTexCoord4dvARB) ++numFailed;
				MultiTexCoord4fARB = reinterpret_cast<PFNMULTITEXCOORD4FARB>(IntGetProcAddress("glMultiTexCoord4fARB"));
				if(!MultiTexCoord4fARB) ++numFailed;
				MultiTexCoord4fvARB = reinterpret_cast<PFNMULTITEXCOORD4FVARB>(IntGetProcAddress("glMultiTexCoord4fvARB"));
				if(!MultiTexCoord4fvARB) ++numFailed;
				MultiTexCoord4iARB = reinterpret_cast<PFNMULTITEXCOORD4IARB>(IntGetProcAddress("glMultiTexCoord4iARB"));
				if(!MultiTexCoord4iARB) ++numFailed;
				MultiTexCoord4ivARB = reinterpret_cast<PFNMULTITEXCOORD4IVARB>(IntGetProcAddress("glMultiTexCoord4ivARB"));
				if(!MultiTexCoord4ivARB) ++numFailed;
				MultiTexCoord4sARB = reinterpret_cast<PFNMULTITEXCOORD4SARB>(IntGetProcAddress("glMultiTexCoord4sARB"));
				if(!MultiTexCoord4sARB) ++numFailed;
				MultiTexCoord4svARB = reinterpret_cast<PFNMULTITEXCOORD4SVARB>(IntGetProcAddress("glMultiTexCoord4svARB"));
				if(!MultiTexCoord4svARB) ++numFailed;
				return numFailed;
			}
			...
			typedef void (CODEGEN_FUNCPTR *PFNLOCKARRAYSEXT)(GLint, GLsizei);
			PFNLOCKARRAYSEXT LockArraysEXT = 0;
			typedef void (CODEGEN_FUNCPTR *PFNUNLOCKARRAYSEXT)();
			PFNUNLOCKARRAYSEXT UnlockArraysEXT = 0;
			
			static int Load_EXT_compiled_vertex_array()
			{
				int numFailed = 0;
				LockArraysEXT = reinterpret_cast<PFNLOCKARRAYSEXT>(IntGetProcAddress("glLockArraysEXT"));
				if(!LockArraysEXT) ++numFailed;
				UnlockArraysEXT = reinterpret_cast<PFNUNLOCKARRAYSEXT>(IntGetProcAddress("glUnlockArraysEXT"));
				if(!UnlockArraysEXT) ++numFailed;
				return numFailed;
			}
			
			typedef void (CODEGEN_FUNCPTR *PFNDRAWRANGEELEMENTSEXT)(GLenum, GLuint, GLuint, GLsizei, GLenum, const GLvoid *);
			PFNDRAWRANGEELEMENTSEXT DrawRangeElementsEXT = 0;
			
			static int Load_EXT_draw_range_elements()
			{
				int numFailed = 0;
				DrawRangeElementsEXT = reinterpret_cast<PFNDRAWRANGEELEMENTSEXT>(IntGetProcAddress("glDrawRangeElementsEXT"));
				if(!DrawRangeElementsEXT) ++numFailed;
				return numFailed;
			}
			
			typedef void (CODEGEN_FUNCPTR *PFNBINDBUFFERARB)(GLenum, GLuint);
			PFNBINDBUFFERARB BindBufferARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNBUFFERDATAARB)(GLenum, GLsizeiptrARB, const GLvoid *, GLenum);
			PFNBUFFERDATAARB BufferDataARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNBUFFERSUBDATAARB)(GLenum, GLintptrARB, GLsizeiptrARB, const GLvoid *);
			PFNBUFFERSUBDATAARB BufferSubDataARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNDELETEBUFFERSARB)(GLsizei, const GLuint *);
			PFNDELETEBUFFERSARB DeleteBuffersARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNGENBUFFERSARB)(GLsizei, GLuint *);
			PFNGENBUFFERSARB GenBuffersARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNGETBUFFERPARAMETERIVARB)(GLenum, GLenum, GLint *);
			PFNGETBUFFERPARAMETERIVARB GetBufferParameterivARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNGETBUFFERPOINTERVARB)(GLenum, GLenum, GLvoid **);
			PFNGETBUFFERPOINTERVARB GetBufferPointervARB = 0;
			typedef void (CODEGEN_FUNCPTR *PFNGETBUFFERSUBDATAARB)(GLenum, GLintptrARB, GLsizeiptrARB, GLvoid *);
			PFNGETBUFFERSUBDATAARB GetBufferSubDataARB = 0;
			typedef GLboolean (CODEGEN_FUNCPTR *PFNISBUFFERARB)(GLuint);
			PFNISBUFFERARB IsBufferARB = 0;
			typedef void * (CODEGEN_FUNCPTR *PFNMAPBUFFERARB)(GLenum, GLenum);
			PFNMAPBUFFERARB MapBufferARB = 0;
			typedef GLboolean (CODEGEN_FUNCPTR *PFNUNMAPBUFFERARB)(GLenum);
			PFNUNMAPBUFFERARB UnmapBufferARB = 0;
			
			static int Load_ARB_vertex_buffer_object()
			{
				int numFailed = 0;
				BindBufferARB = reinterpret_cast<PFNBINDBUFFERARB>(IntGetProcAddress("glBindBufferARB"));
				if(!BindBufferARB) ++numFailed;
				BufferDataARB = reinterpret_cast<PFNBUFFERDATAARB>(IntGetProcAddress("glBufferDataARB"));
				if(!BufferDataARB) ++numFailed;
				BufferSubDataARB = reinterpret_cast<PFNBUFFERSUBDATAARB>(IntGetProcAddress("glBufferSubDataARB"));
				if(!BufferSubDataARB) ++numFailed;
				DeleteBuffersARB = reinterpret_cast<PFNDELETEBUFFERSARB>(IntGetProcAddress("glDeleteBuffersARB"));
				if(!DeleteBuffersARB) ++numFailed;
				GenBuffersARB = reinterpret_cast<PFNGENBUFFERSARB>(IntGetProcAddress("glGenBuffersARB"));
				if(!GenBuffersARB) ++numFailed;
				GetBufferParameterivARB = reinterpret_cast<PFNGETBUFFERPARAMETERIVARB>(IntGetProcAddress("glGetBufferParameterivARB"));
				if(!GetBufferParameterivARB) ++numFailed;
				GetBufferPointervARB = reinterpret_cast<PFNGETBUFFERPOINTERVARB>(IntGetProcAddress("glGetBufferPointervARB"));
				if(!GetBufferPointervARB) ++numFailed;
				GetBufferSubDataARB = reinterpret_cast<PFNGETBUFFERSUBDATAARB>(IntGetProcAddress("glGetBufferSubDataARB"));
				if(!GetBufferSubDataARB) ++numFailed;
				IsBufferARB = reinterpret_cast<PFNISBUFFERARB>(IntGetProcAddress("glIsBufferARB"));
				if(!IsBufferARB) ++numFailed;
				MapBufferARB = reinterpret_cast<PFNMAPBUFFERARB>(IntGetProcAddress("glMapBufferARB"));
				if(!MapBufferARB) ++numFailed;
				UnmapBufferARB = reinterpret_cast<PFNUNMAPBUFFERARB>(IntGetProcAddress("glUnmapBufferARB"));
				if(!UnmapBufferARB) ++numFailed;
				return numFailed;
			}
			...
			typedef void (CODEGEN_FUNCPTR *PFNPOINTPARAMETERINV)(GLenum, GLint);
			PFNPOINTPARAMETERINV PointParameteriNV = 0;
			typedef void (CODEGEN_FUNCPTR *PFNPOINTPARAMETERIVNV)(GLenum, const GLint *);
			PFNPOINTPARAMETERIVNV PointParameterivNV = 0;
			
			static int Load_NV_point_sprite()
			{
				int numFailed = 0;
				PointParameteriNV = reinterpret_cast<PFNPOINTPARAMETERINV>(IntGetProcAddress("glPointParameteriNV"));
				if(!PointParameteriNV) ++numFailed;
				PointParameterivNV = reinterpret_cast<PFNPOINTPARAMETERIVNV>(IntGetProcAddress("glPointParameterivNV"));
				if(!PointParameterivNV) ++numFailed;
				return numFailed;
			}
			...
			typedef GLhandleARB (CODEGEN_FUNCPTR *PFNCREATEPROGRAMOBJECTARB)();
		...
		namespace sys
		{
			namespace 
			{
				...
				{
					table.reserve(34);
					table.push_back(MapEntry("GL_EXT_fog_coord", &exts::var_EXT_fog_coord, _detail::Load_EXT_fog_coord));
					table.push_back(MapEntry("GL_ARB_multitexture", &exts::var_ARB_multitexture, _detail::Load_ARB_multitexture));
					table.push_back(MapEntry("GL_ARB_texture_env_add", &exts::var_ARB_texture_env_add));
					table.push_back(MapEntry("GL_EXT_texture_env_add", &exts::var_EXT_texture_env_add));
					...
					table.push_back(MapEntry("GL_ARB_texture_env_combine", &exts::var_ARB_texture_env_combine));
					table.push_back(MapEntry("GL_EXT_texture_env_combine", &exts::var_EXT_texture_env_combine));
					table.push_back(MapEntry("GL_EXT_compiled_vertex_array", &exts::var_EXT_compiled_vertex_array, _detail::Load_EXT_compiled_vertex_array));
					table.push_back(MapEntry("GL_EXT_draw_range_elements", &exts::var_EXT_draw_range_elements, _detail::Load_EXT_draw_range_elements));
					table.push_back(MapEntry("GL_ARB_texture_mirrored_repeat", &exts::var_ARB_texture_mirrored_repeat));
					table.push_back(MapEntry("GL_ARB_texture_non_power_of_two", &exts::var_ARB_texture_non_power_of_two));
					table.push_back(MapEntry("GL_ARB_vertex_buffer_object", &exts::var_ARB_vertex_buffer_object, _detail::Load_ARB_vertex_buffer_object));
					table.push_back(MapEntry("GL_ARB_pixel_buffer_object", &exts::var_ARB_pixel_buffer_object));
					table.push_back(MapEntry("GL_EXT_pixel_buffer_object", &exts::var_EXT_pixel_buffer_object));
					table.push_back(MapEntry("GL_SGIS_generate_mipmap", &exts::var_SGIS_generate_mipmap));
					...
					table.push_back(MapEntry("GL_NV_texture_rectangle", &exts::var_NV_texture_rectangle));
					table.push_back(MapEntry("GL_EXT_bgra", &exts::var_EXT_bgra));
					table.push_back(MapEntry("GL_ARB_texture_cube_map", &exts::var_ARB_texture_cube_map));
					table.push_back(MapEntry("GL_EXT_texture_cube_map", &exts::var_EXT_texture_cube_map));
					table.push_back(MapEntry("GL_EXT_texture_lod_bias", &exts::var_EXT_texture_lod_bias));
					table.push_back(MapEntry("GL_ARB_point_sprite", &exts::var_ARB_point_sprite));
					table.push_back(MapEntry("GL_NV_point_sprite", &exts::var_NV_point_sprite, _detail::Load_NV_point_sprite));
					table.push_back(MapEntry("GL_ARB_shading_language_100", &exts::var_ARB_shading_language_100));
					...
					table.push_back(MapEntry("GL_ARB_shader_texture_lod", &exts::var_ARB_shader_texture_lod));
					table.push_back(MapEntry("GL_NV_vertex_program3", &exts::var_NV_vertex_program3));
					table.push_back(MapEntry("GL_ARB_texture_float", &exts::var_ARB_texture_float));
					table.push_back(MapEntry("GL_ARB_draw_elements_base_vertex", &exts::var_ARB_draw_elements_base_vertex, _detail::Load_ARB_draw_elements_base_vertex));
				}
				
				void ClearExtensionVars()
				{
					exts::var_EXT_fog_coord = exts::LoadTest();
					exts::var_ARB_multitexture = exts::LoadTest();
					exts::var_ARB_texture_env_add = exts::LoadTest();
					exts::var_EXT_texture_env_add = exts::LoadTest();
					...
					exts::var_ARB_texture_env_combine = exts::LoadTest();
					exts::var_EXT_texture_env_combine = exts::LoadTest();
					exts::var_EXT_compiled_vertex_array = exts::LoadTest();
					exts::var_EXT_draw_range_elements = exts::LoadTest();
					exts::var_ARB_texture_mirrored_repeat = exts::LoadTest();
					exts::var_ARB_texture_non_power_of_two = exts::LoadTest();
					exts::var_ARB_vertex_buffer_object = exts::LoadTest();
					exts::var_ARB_pixel_buffer_object = exts::LoadTest();
					exts::var_EXT_pixel_buffer_object = exts::LoadTest();
					exts::var_SGIS_generate_mipmap = exts::LoadTest();
					exts::var_EXT_framebuffer_object = exts::LoadTest();
					exts::var_ARB_texture_rectangle = exts::LoadTest();
					exts::var_NV_texture_rectangle = exts::LoadTest();
					exts::var_EXT_bgra = exts::LoadTest();
					exts::var_ARB_texture_cube_map = exts::LoadTest();
					exts::var_EXT_texture_cube_map = exts::LoadTest();
					exts::var_EXT_texture_lod_bias = exts::LoadTest();
					exts::var_ARB_point_sprite = exts::LoadTest();
					exts::var_NV_point_sprite = exts::LoadTest();
					exts::var_ARB_shading_language_100 = exts::LoadTest();
					...
					exts::var_ARB_shader_texture_lod = exts::LoadTest();
					exts::var_NV_vertex_program3 = exts::LoadTest();
					exts::var_ARB_texture_float = exts::LoadTest();
					exts::var_ARB_draw_elements_base_vertex = exts::LoadTest();
				}
			...
			exts::LoadTest LoadFunctions()
			{
				...
				ProcExtsFromExtString((const char *)gl2::gl::_detail::GetString(gl2::gl::EXTENSIONS), table);
