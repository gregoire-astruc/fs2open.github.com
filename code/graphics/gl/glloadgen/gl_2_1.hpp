#ifndef GL2_FUNCTION_CPP_GENERATED_HEADEROPENGL_HPP
#define GL2_FUNCTION_CPP_GENERATED_HEADEROPENGL_HPP
...
namespace gl2
{
	namespace gl
	{
		namespace exts
		{
			...
			extern LoadTest var_EXT_fog_coord;
			extern LoadTest var_ARB_multitexture;
			extern LoadTest var_ARB_texture_env_add;
			extern LoadTest var_EXT_texture_env_add;
			...
			extern LoadTest var_ARB_texture_env_combine;
			extern LoadTest var_EXT_texture_env_combine;
			extern LoadTest var_EXT_compiled_vertex_array;
			extern LoadTest var_EXT_draw_range_elements;
			extern LoadTest var_ARB_texture_mirrored_repeat;
			extern LoadTest var_ARB_texture_non_power_of_two;
			extern LoadTest var_ARB_vertex_buffer_object;
			extern LoadTest var_ARB_pixel_buffer_object;
			extern LoadTest var_EXT_pixel_buffer_object;
			extern LoadTest var_SGIS_generate_mipmap;
			extern LoadTest var_EXT_framebuffer_object;
			extern LoadTest var_ARB_texture_rectangle;
			extern LoadTest var_NV_texture_rectangle;
			extern LoadTest var_EXT_bgra;
			extern LoadTest var_ARB_texture_cube_map;
			extern LoadTest var_EXT_texture_cube_map;
			extern LoadTest var_EXT_texture_lod_bias;
			extern LoadTest var_ARB_point_sprite;
			extern LoadTest var_NV_point_sprite;
			extern LoadTest var_ARB_shading_language_100;
			extern LoadTest var_ARB_shader_objects;
			extern LoadTest var_ARB_vertex_shader;
			extern LoadTest var_ARB_fragment_shader;
			extern LoadTest var_ARB_shader_texture_lod;
			extern LoadTest var_NV_vertex_program3;
			extern LoadTest var_ARB_texture_float;
			extern LoadTest var_ARB_draw_elements_base_vertex;
		...
		enum
		{
			...
			//MAX_VERTEX_TEXTURE_IMAGE_UNITS_ARB taken from ext: ARB_vertex_shader
		...
		namespace _detail
		{
			extern void (CODEGEN_FUNCPTR *FogCoordPointerEXT)(GLenum type, GLsizei stride, const GLvoid * pointer);
			extern void (CODEGEN_FUNCPTR *FogCoorddEXT)(GLdouble coord);
			extern void (CODEGEN_FUNCPTR *FogCoorddvEXT)(const GLdouble * coord);
			extern void (CODEGEN_FUNCPTR *FogCoordfEXT)(GLfloat coord);
			extern void (CODEGEN_FUNCPTR *FogCoordfvEXT)(const GLfloat * coord);
			
			extern void (CODEGEN_FUNCPTR *ActiveTextureARB)(GLenum texture);
			extern void (CODEGEN_FUNCPTR *ClientActiveTextureARB)(GLenum texture);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1dARB)(GLenum target, GLdouble s);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1dvARB)(GLenum target, const GLdouble * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1fARB)(GLenum target, GLfloat s);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1fvARB)(GLenum target, const GLfloat * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1iARB)(GLenum target, GLint s);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1ivARB)(GLenum target, const GLint * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1sARB)(GLenum target, GLshort s);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord1svARB)(GLenum target, const GLshort * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2dARB)(GLenum target, GLdouble s, GLdouble t);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2dvARB)(GLenum target, const GLdouble * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2fARB)(GLenum target, GLfloat s, GLfloat t);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2fvARB)(GLenum target, const GLfloat * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2iARB)(GLenum target, GLint s, GLint t);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2ivARB)(GLenum target, const GLint * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2sARB)(GLenum target, GLshort s, GLshort t);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord2svARB)(GLenum target, const GLshort * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3dARB)(GLenum target, GLdouble s, GLdouble t, GLdouble r);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3dvARB)(GLenum target, const GLdouble * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3fARB)(GLenum target, GLfloat s, GLfloat t, GLfloat r);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3fvARB)(GLenum target, const GLfloat * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3iARB)(GLenum target, GLint s, GLint t, GLint r);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3ivARB)(GLenum target, const GLint * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3sARB)(GLenum target, GLshort s, GLshort t, GLshort r);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord3svARB)(GLenum target, const GLshort * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4dARB)(GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4dvARB)(GLenum target, const GLdouble * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4fARB)(GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4fvARB)(GLenum target, const GLfloat * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4iARB)(GLenum target, GLint s, GLint t, GLint r, GLint q);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4ivARB)(GLenum target, const GLint * v);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4sARB)(GLenum target, GLshort s, GLshort t, GLshort r, GLshort q);
			extern void (CODEGEN_FUNCPTR *MultiTexCoord4svARB)(GLenum target, const GLshort * v);
			...
			extern void (CODEGEN_FUNCPTR *LockArraysEXT)(GLint first, GLsizei count);
			extern void (CODEGEN_FUNCPTR *UnlockArraysEXT)();
			
			extern void (CODEGEN_FUNCPTR *DrawRangeElementsEXT)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid * indices);
			
			
			
			extern void (CODEGEN_FUNCPTR *BindBufferARB)(GLenum target, GLuint buffer);
			extern void (CODEGEN_FUNCPTR *BufferDataARB)(GLenum target, GLsizeiptrARB size, const GLvoid * data, GLenum usage);
			extern void (CODEGEN_FUNCPTR *BufferSubDataARB)(GLenum target, GLintptrARB offset, GLsizeiptrARB size, const GLvoid * data);
			extern void (CODEGEN_FUNCPTR *DeleteBuffersARB)(GLsizei n, const GLuint * buffers);
			extern void (CODEGEN_FUNCPTR *GenBuffersARB)(GLsizei n, GLuint * buffers);
			extern void (CODEGEN_FUNCPTR *GetBufferParameterivARB)(GLenum target, GLenum pname, GLint * params);
			extern void (CODEGEN_FUNCPTR *GetBufferPointervARB)(GLenum target, GLenum pname, GLvoid ** params);
			extern void (CODEGEN_FUNCPTR *GetBufferSubDataARB)(GLenum target, GLintptrARB offset, GLsizeiptrARB size, GLvoid * data);
			extern GLboolean (CODEGEN_FUNCPTR *IsBufferARB)(GLuint buffer);
			extern void * (CODEGEN_FUNCPTR *MapBufferARB)(GLenum target, GLenum access);
			extern GLboolean (CODEGEN_FUNCPTR *UnmapBufferARB)(GLenum target);
			...
			extern void (CODEGEN_FUNCPTR *PointParameteriNV)(GLenum pname, GLint param);
			extern void (CODEGEN_FUNCPTR *PointParameterivNV)(GLenum pname, const GLint * params);
			...
			extern GLhandleARB (CODEGEN_FUNCPTR *CreateProgramObjectARB)();
		...
		inline void FogCoordPointerEXT(GLenum type, GLsizei stride, const GLvoid * pointer){_detail::FogCoordPointerEXT(type, stride, pointer);}
		inline void FogCoorddEXT(GLdouble coord){_detail::FogCoorddEXT(coord);}
		inline void FogCoorddvEXT(const GLdouble * coord){_detail::FogCoorddvEXT(coord);}
		inline void FogCoordfEXT(GLfloat coord){_detail::FogCoordfEXT(coord);}
		inline void FogCoordfvEXT(const GLfloat * coord){_detail::FogCoordfvEXT(coord);}
		
		inline void ActiveTextureARB(GLenum texture){_detail::ActiveTextureARB(texture);}
		inline void ClientActiveTextureARB(GLenum texture){_detail::ClientActiveTextureARB(texture);}
		inline void MultiTexCoord1dARB(GLenum target, GLdouble s){_detail::MultiTexCoord1dARB(target, s);}
		inline void MultiTexCoord1dvARB(GLenum target, const GLdouble * v){_detail::MultiTexCoord1dvARB(target, v);}
		inline void MultiTexCoord1fARB(GLenum target, GLfloat s){_detail::MultiTexCoord1fARB(target, s);}
		inline void MultiTexCoord1fvARB(GLenum target, const GLfloat * v){_detail::MultiTexCoord1fvARB(target, v);}
		inline void MultiTexCoord1iARB(GLenum target, GLint s){_detail::MultiTexCoord1iARB(target, s);}
		inline void MultiTexCoord1ivARB(GLenum target, const GLint * v){_detail::MultiTexCoord1ivARB(target, v);}
		inline void MultiTexCoord1sARB(GLenum target, GLshort s){_detail::MultiTexCoord1sARB(target, s);}
		inline void MultiTexCoord1svARB(GLenum target, const GLshort * v){_detail::MultiTexCoord1svARB(target, v);}
		inline void MultiTexCoord2dARB(GLenum target, GLdouble s, GLdouble t){_detail::MultiTexCoord2dARB(target, s, t);}
		inline void MultiTexCoord2dvARB(GLenum target, const GLdouble * v){_detail::MultiTexCoord2dvARB(target, v);}
		inline void MultiTexCoord2fARB(GLenum target, GLfloat s, GLfloat t){_detail::MultiTexCoord2fARB(target, s, t);}
		inline void MultiTexCoord2fvARB(GLenum target, const GLfloat * v){_detail::MultiTexCoord2fvARB(target, v);}
		inline void MultiTexCoord2iARB(GLenum target, GLint s, GLint t){_detail::MultiTexCoord2iARB(target, s, t);}
		inline void MultiTexCoord2ivARB(GLenum target, const GLint * v){_detail::MultiTexCoord2ivARB(target, v);}
		inline void MultiTexCoord2sARB(GLenum target, GLshort s, GLshort t){_detail::MultiTexCoord2sARB(target, s, t);}
		inline void MultiTexCoord2svARB(GLenum target, const GLshort * v){_detail::MultiTexCoord2svARB(target, v);}
		inline void MultiTexCoord3dARB(GLenum target, GLdouble s, GLdouble t, GLdouble r){_detail::MultiTexCoord3dARB(target, s, t, r);}
		inline void MultiTexCoord3dvARB(GLenum target, const GLdouble * v){_detail::MultiTexCoord3dvARB(target, v);}
		inline void MultiTexCoord3fARB(GLenum target, GLfloat s, GLfloat t, GLfloat r){_detail::MultiTexCoord3fARB(target, s, t, r);}
		inline void MultiTexCoord3fvARB(GLenum target, const GLfloat * v){_detail::MultiTexCoord3fvARB(target, v);}
		inline void MultiTexCoord3iARB(GLenum target, GLint s, GLint t, GLint r){_detail::MultiTexCoord3iARB(target, s, t, r);}
		inline void MultiTexCoord3ivARB(GLenum target, const GLint * v){_detail::MultiTexCoord3ivARB(target, v);}
		inline void MultiTexCoord3sARB(GLenum target, GLshort s, GLshort t, GLshort r){_detail::MultiTexCoord3sARB(target, s, t, r);}
		inline void MultiTexCoord3svARB(GLenum target, const GLshort * v){_detail::MultiTexCoord3svARB(target, v);}
		inline void MultiTexCoord4dARB(GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q){_detail::MultiTexCoord4dARB(target, s, t, r, q);}
		inline void MultiTexCoord4dvARB(GLenum target, const GLdouble * v){_detail::MultiTexCoord4dvARB(target, v);}
		inline void MultiTexCoord4fARB(GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q){_detail::MultiTexCoord4fARB(target, s, t, r, q);}
		inline void MultiTexCoord4fvARB(GLenum target, const GLfloat * v){_detail::MultiTexCoord4fvARB(target, v);}
		inline void MultiTexCoord4iARB(GLenum target, GLint s, GLint t, GLint r, GLint q){_detail::MultiTexCoord4iARB(target, s, t, r, q);}
		inline void MultiTexCoord4ivARB(GLenum target, const GLint * v){_detail::MultiTexCoord4ivARB(target, v);}
		inline void MultiTexCoord4sARB(GLenum target, GLshort s, GLshort t, GLshort r, GLshort q){_detail::MultiTexCoord4sARB(target, s, t, r, q);}
		inline void MultiTexCoord4svARB(GLenum target, const GLshort * v){_detail::MultiTexCoord4svARB(target, v);}
		...
		inline void LockArraysEXT(GLint first, GLsizei count){_detail::LockArraysEXT(first, count);}
		inline void UnlockArraysEXT(){_detail::UnlockArraysEXT();}
		
		inline void DrawRangeElementsEXT(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid * indices){_detail::DrawRangeElementsEXT(mode, start, end, count, type, indices);}
		
		
		
		inline void BindBufferARB(GLenum target, GLuint buffer){_detail::BindBufferARB(target, buffer);}
		inline void BufferDataARB(GLenum target, GLsizeiptrARB size, const GLvoid * data, GLenum usage){_detail::BufferDataARB(target, size, data, usage);}
		inline void BufferSubDataARB(GLenum target, GLintptrARB offset, GLsizeiptrARB size, const GLvoid * data){_detail::BufferSubDataARB(target, offset, size, data);}
		inline void DeleteBuffersARB(GLsizei n, const GLuint * buffers){_detail::DeleteBuffersARB(n, buffers);}
		inline void GenBuffersARB(GLsizei n, GLuint * buffers){_detail::GenBuffersARB(n, buffers);}
		inline void GetBufferParameterivARB(GLenum target, GLenum pname, GLint * params){_detail::GetBufferParameterivARB(target, pname, params);}
		inline void GetBufferPointervARB(GLenum target, GLenum pname, GLvoid ** params){_detail::GetBufferPointervARB(target, pname, params);}
		inline void GetBufferSubDataARB(GLenum target, GLintptrARB offset, GLsizeiptrARB size, GLvoid * data){_detail::GetBufferSubDataARB(target, offset, size, data);}
		inline GLboolean IsBufferARB(GLuint buffer){return _detail::IsBufferARB(buffer);}
		inline void * MapBufferARB(GLenum target, GLenum access){return _detail::MapBufferARB(target, access);}
		inline GLboolean UnmapBufferARB(GLenum target){return _detail::UnmapBufferARB(target);}
		...
		inline void PointParameteriNV(GLenum pname, GLint param){_detail::PointParameteriNV(pname, param);}
		inline void PointParameterivNV(GLenum pname, const GLint * params){_detail::PointParameterivNV(pname, params);}
		...
		inline GLhandleARB CreateProgramObjectARB(){return _detail::CreateProgramObjectARB();}
...
#endif //GL2_FUNCTION_CPP_GENERATED_HEADEROPENGL_HPP
