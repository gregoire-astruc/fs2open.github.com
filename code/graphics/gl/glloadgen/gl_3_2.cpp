		...
		namespace sys
		{
			...
			namespace 
			{
				static void ProcExtsFromExtList(std::vector<MapEntry> &table)
				{
					...
					gl3::gl::_detail::GetIntegerv(gl3::gl::NUM_EXTENSIONS, &iNumExtensions);
				
					for(iLoop = 0; iLoop < iNumExtensions; iLoop++)
					{
						const char *strExtensionName = (const char *)gl3::gl::_detail::GetStringi(gl3::gl::EXTENSIONS, iLoop);
