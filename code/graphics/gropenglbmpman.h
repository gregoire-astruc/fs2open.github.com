...
int gr_opengl_bm_load(ubyte type, int n, const char *filename, cfile::FileHandle *img_cfp = NULL, int *w = 0, int *h = 0, int *bpp = 0, ubyte *c_type = 0, int *mm_lvl = 0, int *size = 0);
